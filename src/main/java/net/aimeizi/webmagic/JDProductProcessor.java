...
public class JDProductProcessor implements PageProcessor {
    ...
    public static void main(String[] args) throws Exception {
       ...
       // String chromeDriverPath = "C:/Users/Administrator/Desktop/solrj-example-master/src/main/resources/chromedriver.exe";
        String chromeDriverPath = "C:/Users/Administrator/Desktop/solrj-example-master/chromedriver.exe";
        System.out.println(chromeDriverPath);
        Spider jdSpider = Spider.create(new JDProductProcessor()).addUrl("http://www.jd.com/allSort.aspx")// JD全部分类
                        .addPipeline(jdPipeline).setDownloader(new SeleniumDownloader(chromeDriverPath)).thread(5);
        // 注册爬虫监控
