...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${ctx }/css/360buyimg.css" media="all"/>
    <link rel="stylesheet" type="text/css" href="${ctx }/css/list.css" media="all"/>
...
<div class="w" style="margin-top: 50px;">
    <img src="${ctx }/images/solr.png" style="float: right;"/>

    <div id="logo-2014">
        <a href="${ctx }/" class="logo">京东</a>
    </div>
    <div id="search-2014">
        <div class="form">
            <form action="${ctx }/search" method="post" name="searchform" id="searchform">
...
<div id="full"
    ...
    <a href="#" onclick="goTop();return false;">
        <img src="${ctx }/images/top.png" width="70px;" height="70px;" border=0 alt="回到顶部">
    </a>
</div>
<script src="${ctx }/js/top.js" type="text/javascript"></script>
<script src="http://cdn.bootcss.com/jquery/1.10.2/jquery.js"></script>
<script src="${ctx }/js/jquery.pager.js" type="text/javascript" charset="utf-8"></script>
