    ...
    <div class="search">
        <div class="container">
            <section>
                <div class="row-fluid">
                    <div>
                        <form id="searchform" name="searchform" action="${ctx }/news/search" class="form-inline" method="post">
...
<div id="full" style="width:0px; height:0px; position:fixed; right:70px; bottom:150px; z-index:100; text-align:center; background-color:transparent; cursor:pointer;">
    <a href="#" onclick="goTop();return false;"><img src="${ctx }/images/top.png" width="70px;" height="70px;" border=0 alt="回到顶部"></a>
</div>
